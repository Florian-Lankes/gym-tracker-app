const CACHE = 'lift-log-v8';
const ASSETS = ['./', './index.html', './manifest.webmanifest', './src/app.js', './src/data.js', './src/db.js', './src/theme.js', './src/backup.js', './src/statistics.js', './src/styles.css', './icons/icon.svg'];
